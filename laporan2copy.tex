...
\begin{itemize}
    ...
    \item \textbf{Variabel Independen ($information$)}: Jumlah populasi bekerja (16-74 tahun) yang bekerja di bidang informasi dan komunikasi  (\texttt{Information\_and\_communication}).
...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        CONSTANT & 1289.1426 & 393.284 & 3.278 & 0.001 \\
        Education & 1.0658 & 0.054 & 19.912 & 0.000 \\
        Financial & -0.0527 & 0.074 & -0.714 & 0.476 \\
        Info \& Comm & -0.7253 & 0.075 & -9.705 & 0.000 \\
        Real Estate & 2.9287 & 0.547  & 5.356 & 0.000 \\
        \bottomrule
    \end{tabular}
\end{table}
...
Pertama, nilai konstanta (CONSTANT) sebesar 0.0001 dengan nilai probabilitas 0.996 menunjukkan bahwa parameter intercept tidak signifikan secara statistik pada tingkat signifikansi 5\%. Hal ini mengindikasikan bahwa ketika seluruh variabel independen bernilai nol, tidak terdapat pengaruh dasar yang signifikan terhadap variabel dependen. Namun demikian, dalam konteks analisis regresi spasial, interpretasi konstanta bukanlah fokus utama karena perhatian lebih diarahkan pada arah dan signifikansi variabel penjelas.

Variabel \textit{Education} memiliki koefisien sebesar 0.8580 dan signifikan pada tingkat 1\% (p-value = 0.000). Nilai z-statistic sebesar 18.486 menunjukkan bahwa pengaruh variabel ini sangat kuat secara statistik. Koefisien positif mengindikasikan bahwa peningkatan satu satuan pada sektor pendidikan akan meningkatkan sektor \textit{Human Health and Social Work} sebesar 0.8580 satuan, dengan asumsi variabel lain konstan. Secara substantif, hasil ini menunjukkan bahwa wilayah dengan tingkat aktivitas pendidikan yang lebih tinggi cenderung memiliki tenaga kerja sektor kesehatan dan pekerjaan sosial yang lebih besar. Temuan ini konsisten dengan teori modal manusia (\textit{human capital theory}), di mana pendidikan meningkatkan kualitas dan kapasitas tenaga kerja dalam sektor pelayanan publik.

Selanjutnya, variabel \textit{Financial} (Financial and Insurance) memiliki koefisien negatif sebesar -0.0111 dan tidak signifikan (p-value = 0.733). Nilai ini menunjukkan bahwa secara statistik, sektor keuangan dan asuransi tidak memiliki pengaruh yang bermakna terhadap variasi sektor kesehatan dan pekerjaan sosial. Ketidaksignifikanan ini dapat diinterpretasikan bahwa dinamika sektor keuangan mungkin tidak secara langsung mempengaruhi distribusi tenaga kerja kesehatan pada tingkat wilayah yang dianalisis, atau pengaruhnya telah terakomodasi melalui variabel lain dalam model.

Variabel \textit{Info \& Comm} (Information and Communication) memiliki koefisien negatif sebesar -0.2714 dan signifikan pada tingkat 1\% (p-value = 0.000). Nilai z-statistic sebesar -8.866 menunjukkan kekuatan pengaruh yang tinggi secara statistik. Koefisien negatif ini mengindikasikan bahwa peningkatan aktivitas sektor informasi dan komunikasi berkorelasi dengan penurunan proporsi sektor kesehatan dan pekerjaan sosial. Secara ekonomi regional, hal ini dapat mencerminkan adanya spesialisasi sektor, di mana wilayah yang berkembang pada sektor teknologi dan komunikasi cenderung memiliki struktur ekonomi yang lebih terfokus pada sektor tersier berbasis teknologi dibandingkan pelayanan kesehatan dan sosial.

Variabel \textit{Real Estate} memiliki koefisien positif sebesar 0.3616 dan signifikan pada tingkat 1\% (p-value = 0.000). Nilai z-statistic sebesar 5.587 menunjukkan bahwa pengaruhnya signifikan secara statistik. Koefisien ini menunjukkan bahwa peningkatan sektor real estat berkorelasi dengan peningkatan sektor kesehatan dan pekerjaan sosial. Secara konseptual, perkembangan real estat sering kali mencerminkan pertumbuhan wilayah dan peningkatan kepadatan penduduk, yang pada gilirannya meningkatkan kebutuhan terhadap layanan kesehatan dan sosial.
...
\begin{enumerate}
    \item Terdapat autokorelasi spasial yang signifikan pada residual model OLS, sehingga model OLS klasik tidak sepenuhnya memadai.
...
\begin{center}
    ...
    \url{https://github.com/ammarhnfi/TK2}
\end{center}
